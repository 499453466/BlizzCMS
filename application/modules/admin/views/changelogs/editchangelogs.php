                    ...
                    <div class="uk-card uk-card-default uk-card-small">
                        ...
                        <div class="uk-card-body">
                            <form action="" method="post" enctype="multipart/form-data" accept-charset="utf-8" autocomplete="off">
                                ...
                                <button class="uk-button uk-button-primary uk-width-1-1" name="button_updateChangelog" type="submit"><i class="fa fa-refresh" aria-hidden="true"></i> <?= $this->lang->line('button_save'); ?></button>
                            </form>
                        </div>
                    </div>
                </div>
